    ...
    <div id="header">
        ...
        <div class="banner">
            ...
            <div class="sub-banner">
                <a href="DongHoServlet"><img class="logo" style="color: red; width: 60%; height:79px;  " src="img/logodonghonho1.jpg" alt="" /></a>
    ...
    <nav style="margin-left: 0px;">
       ...
       <li class="f"><a style="color: black; margin-left: 150px;" href="DongHoServlet">Trang chủ</a></li>
            ...
            <li class="dmsp" ><a href="#">THƯƠNG HIỆU<i class="fas fa-caret-down"></i></a>
                <ul class="sub-menu">
                    <li><a href="#rolex">SHOPEE</a></li>
                    <li><a href="#seiko">TIKI</a></li>
                </ul>
          </li>
            
         <li>
                <a href="#">LOẠI<i class="fas fa-caret-down"></i></a>
                <ul class="sub-menu">  
                   <li><a href="DongHoServlet?command=DONGHONAM">GẤU BÔNG NAM</a></li>
                    <li><a href="DongHoServlet?command=DONGHONU">GẤU BÔNG NỮ</a></li>
                     <li><a href="DongHoServlet?command=TATCADONGHO">TẤT CẢ GẤU BÔNG</a></li>
          ...
          <li>
            ...
            <ul class="sub-menu">
                 ...
                 <li><a href="DongHoServlet?command=THONGBAO">SHOPEE</a></li>
                <li><a href="DongHoServlet?command=THONGBAO">TIKI</a></li>
            </ul>
          </li>
            ...
            <li>
	            <a href="#">TIN TỨC<i class="fas fa-caret-down"></i></a>
	             <ul class="sub-menu">
	                ...
	                <li><a href="DongHoServlet?command=TINTUC">TIn GẤU BÔNG</a></li>
      ...
      <div class="slider">
  <img src="img/logodh.jpg" style="height: 250px;">
 </div>
 <div id="wrapper">
    ...
    <div class="contaner">
        <div class="row">
            <div class="row ml-5">
                ...
                <h6 style="color: gray;"> > Tin GẤU BÔNG thời trang</h6>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-9">
                <div class="border-bottom">
                    <h3 style = "font-family:courier,arial,helvetica;">Tin GẤU BÔNG thời trang</h3>
                </div>
                <h2 style="text-align: center;">Phân biệt GẤU BÔNG chính hãng với hàng giả cùng LUXURY BRAND</h2>
                <p style="font-family:Lucida Calligraphy,Comic Sans MS,Lucida Console; text-align: center;">POSTED BY · FEBRUARY 20, 2021</p>
                <a href="tintucchitiet.html"><img src="imgDongHo/logodh15.jpg" width="85%" style="margin-left: 30px;"></a>
                
                <a href="tintucchitiet.html"><p style="font-weight: bold; margin-left: 30px; color: black;">Biết cách phân biệt GẤU BÔNG chính hãng với GẤU BÔNG giả là cách tốt nhất để bạn
                     có thể sở hữu những chiếc GẤU BÔNG chất lượng, phù hợp với túi tiền.</p></a>
                ...
                <h2 style="text-align: center;">Hướng dẫn chọn GẤU BÔNG phù hợp với bản thân</h2>
                <p style="font-family:Lucida Calligraphy,Comic Sans MS,Lucida Console; text-align: center;">POSTED BY · FEBRUARY 19, 2021</p>
                <img src="imgDongHo/logodh16.jpg" width="85%" style="margin-left: 30px;">
                <p style="font-weight: bold; margin-left: 30px;">Việc chọn một chiếc GẤU BÔNG phù hợp có thể có ảnh hưởng lớn đến phong cách và cảm nhận cá nhân của bạn.</p>
                <div class="border-bottom">
                    <!--  <button type="submit" style="border-radius: 3px; margin-left: 30px;">Read more</button>-->
                ...
                <h2 style="text-align: center;">Xu hướng GẤU BÔNG năm 2023</h2>
                <p style="font-family:Lucida Calligraphy,Comic Sans MS,Lucida Console; text-align: center;">POSTED BY · NOVEMBER 13, 2023</p>
                <img src="imgDongHo/logodh15.jpg"  width="85%" style="margin-left: 30px;">
                <p style="font-weight: bold; margin-left: 30px;">Không chỉ là một vật dụng để xem giờ, GẤU BÔNG còn nâng tầm phong cách cho người dùng. 
                    Khám phá ngay xu hướng GẤU BÔNG thời trang mới nhất.</p>
                <div class="border-bottom">
                     <!--  <button type="submit" style="border-radius: 3px; margin-left: 30px;">Read more</button>-->
                ...
                <h2 style="text-align: center;">GẤU BÔNG đẹp nhất thế giới Midnight Planetarium</h2>
                <p style="font-family:Lucida Calligraphy,Comic Sans MS,Lucida Console; text-align: center;">POSTED BY · AUGUST 12, 2020</p>
                <img src="imgDongHo/logodh16.jpg"  width="85%" style="margin-left: 30px;">
                <p style="font-weight: bold; margin-left: 30px;">Đây là một trong số ít những chiếc GẤU BÔNG thiên văn tái hiện lại 6 hành tinh nhỏ xoay quanh mặt trời bằng 6 viên đá quý, mặt trời bằng vàng.</p>
                <div class="border-bottom">
                ...
                <h2 style="text-align: center;">GẤU BÔNG đắt nhất thế giới 2023</h2>
                <p style="font-family:Lucida Calligraphy,Comic Sans MS,Lucida Console; text-align: center;">POSTED BY · AUGUST 12, 2020</p>
                <img src="imgDongHo/logodh15.png"  width="85%" style="margin-left: 30px;">
                <p style="font-weight: bold; margin-left: 30px;">Graff Diamonds Hallucination là chiếc GẤU BÔNG đắt nhất thế giới, với mức giá 55 triệu USD. Chiếc GẤU BÔNG này được trang trí bằng hơn 110 carat kim cương 
            ...
            <div class="col-md-3">
                ...
                <p style="font-family:Lucida Calligraphy,Comic Sans MS,Lucida Console;">Phân biệt GẤU BÔNG chính hãng với hàng giả cùng D&H eyeglass</p>
                <p style="font-family:Garamond;">FEBRUARY 19, 2021</p>
                <p style="font-family:Lucida Calligraphy,Comic Sans MS,Lucida Console;">Hướng dẫn chọn GẤU BÔNG phù hợp với bản thân</p>
                <p style="font-family:Garamond;">NOVEMBER 13, 2020</p>
                <p style="font-family:Lucida Calligraphy,Comic Sans MS,Lucida Console;">Xu hướng GẤU BÔNG 2023</p>
        ...
        <div class="container">
             <div class="footer-main">
                <div class="footer-main__map">
                    <img src="imgDongHo/logodh15.jpg" width="99%" height="99%"  style="border:0;" allowfullscreen="" loading=""></img>
                </div>
                ...
                <div class="footer-list">
                    <div class="footer-wraper-1">
                        ...
                        <p class="footer-desc">LUXURY BRAND, thành lập vào năm 2023, chuyên cung cấp GẤU BÔNG hàng hiệu chính hãng tại TPHCM. 
                        Chúng tôi mang đến các sản phẩm GẤU BÔNG cao cấp, 
                        từ những mẫu GẤU BÔNG thời trang đến những chiếc GẤU BÔNG nam nữ tầm trung, 
            ...
            <div class="copyright">
                    <div class="copyright-main">
                      @2021 - <span class="copyright-main__color">GẤU BÔNG LUXURY BRAND</span> 
