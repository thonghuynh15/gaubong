  ...
  <img  style="height: 250px;" src="imgDongHo/logodh7.PNG" alt="">
    ...
    <div class="contaner" >
        ...
        <div class="row" style="padding-top: 20px;">
            <div class="col-md-8">
                <div class="border-bottom">
                    <img src="imgDongHo/logodh15.jpg" style=" width: 80%; margin-left: 20px; ">
                </div>
                
                    <img src="imgDongHo/logodh16.jpg" style=" width: 80%; margin-left: 20px; margin-top: 60px; ">
            </div>
        <div class="col-md-4 ">
            <div class="border-bottom">
                <h3 style="font-family:Garamond;">GẤU BÔNG LUXURY BRAND</h3>
                <p>Address: HCM - 12 Nguyễn Văn Bảo - Quận Gò Vấp</p>
           
                <p>Nếu bạn là người quan tâm đặc biệt đến GẤU BÔNG và thường mua sắm GẤU BÔNG trực tuyến, 
                có thể bạn đã từng nghe đến thương hiệu LUXURY BRAND? Đúng vậy, đây là một thương hiệu đã có hơn 12 năm trong ngành, 
                chủ yếu hoạt động thông qua trang web bán hàng trực tuyến, chuyên cung cấp GẤU BÔNG hàng hiệu chính hãng tại TP.HCM.</p>
            </div>
            <h4 style="font-family:Garamond; margin-top: 30px;">CỬA HÀNG GẤU BÔNG CUNG CẤP CÁC LOẠI GẤU BÔNG SANG TRỌNG BẬC NHẤT TẠI VIỆT NAM</h4>
            <p>+ Hàng chất lượng cao, dịch vụ tốt đảm bảo cho khách hàng</p>
