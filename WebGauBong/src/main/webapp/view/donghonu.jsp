                    ...
                    <div class="row">
                        ...
                        <c:url var="tempLink" value="DongHoServlet">
						    ...
						    <div class="col-12 col-md-6 col-lg-3">
						        ...
						        <div class="card">
						            <a href="${tempLink}"><img class="card-img-top" src="${dsDongHoNu.hinhAnh}" alt="Card image cap"></a>
                                    <div class="card-body">
                                        <h4 class="card-title show_txt"><a href="#" style="color: #7A7A7A" >${dsDongHoNu.tenDH}</a></h4>
                                        <%-- <p class="card-text show_txt">${dsTatCaDongHo.tenDH}</p> --%>
                                        <div class="row">
                                            <div class="col">
                                                <p class="btn btn-danger btn-block">${dsDongHoNu.giaBan} $</p>
                                            </div>
                                            <div class="col">
