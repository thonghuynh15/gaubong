...
<head>
  <meta charset="UTF-8" />
    ...
    <title>Trang Chủ Bán gấu bông</title>
</head>
...
<!-- ============END HEADER=============== -->
    ...
    <nav style="margin-left: 0px;">
        ...
        <c:if test="${not empty sessionScope.acc}">
            ...
            <li class="dmsp" ><a href="#">THƯƠNG HIỆU<i class="fas fa-caret-down"></i></a>
                ...
                <c:forEach var="brand" items="${LIST_BRANDS}">
                    ...
                    <li ><a href="#rolex" >TIKI</a></li>
                    <li><a href="#seiko">SHOPEE</a></li>
                </ul>
          </li>
         ...
         <li>
                ...
                <ul class="sub-menu">  
                    <li><a href="DongHoServlet?command=DONGHONAM">GẤU BÔNG SHOPEE</a></li>
                    <li><a href="DongHoServlet?command=DONGHONU">GẤU BÔNG TIKI</a></li>
          ...
          <li>
           ...
           <c:if test ="${sessionScope.acc.isAdmin == 1}">
	                 ...
	                 <li><a href="CRUDServlet" >QUẢN LÝ GẤU BÔNG</a>
      ...
      <div class="slider">
  <img src="img/logodh.jpg" style="height: 600px;">
 </div>
 <div id="wrapper">
    <!-- ========>END HEADER<====== -->
   ...
   <!-- ============CONTENT=============== -->
    <div id="content">
        <div class="slogan">
            <h2>GẤU BÔNG CHÍNH HÃNG</h2>
            <P>Chúng tôi cam kết mang lại những giá trị cao nhất, chế độ hậu mãi tốt nhất & gấu bông chính hãng cho khách hàng khi đến với DONGHOHIEU.com</P>
       </div>  
        <div id="box-head">
            <div class="head-img">
      ...
      <!--   gấu bông NAM BÁN CHẠY -->
	<div class="section" id="dhnam">
	
	    <div class="title-body">
	        <h2>
	            <i class="fab fa-battle-net"></i> GẤU BÔNG SHOPEE BÁN CHẠY NHẤT
	...
	<!--   gấu bông Nữ BÁN CHẠY -->
	
	<div class="section" id="dhnu">
	
	    <div class="title-body">
	        <h2>
	            <i class="fab fa-battle-net"></i> GẤU BÔNG TIKI BÁN CHẠY NHẤT
	            <i class="fab fa-battle-net"></i>
	        </h2>
	...
	<div class="col-sm-12" id="tatcadongho">
	 	<div class="box-head">
	        	<p id="converse">TẤT CẢ GẤU BÔNG</p>
	    </div>
                    <div class="row">
        ...
        <div class="box-head">
         ...
         <div class="container">
            <div class="row">
                <div class="col-6">
                    <a href="DongHoServlet?command=TINTUC"><img src="imgDongHo/logodh2.jpg" width="85%" style="margin-left: 30px;"></a>
                    <a href="DongHoServlet?command=TINTUC"><h2 style="color: black;">GẤU BÔNG LUXURY</h2></a>
                    <p>Gấu bông chất lượng, phù hợp với túi tiền.
                    </p>
                </div>
                <div class="col-6">
                    <a href="#"><img src="imgDongHo/logodh16.jpg" width="85%" style="margin-left: 30px;"></a>
                    <a href="#"> <h2 style="color: black;">Hướng dẫn chọn gấu bông</h2></a>
                    <p>Việc chọn một chú gấu bông ảnh hưởng lớn đến từ phong cách và cảm nhận cá nhân của bạn.
                    </p>
                 </div>
            </div>
        </div>
